...
data class ExtractedPropositions(val propositions: List<String>)

/**
 * Service to extract atomic semantic propositions from complex text. Uses Embabel AI to perform
    ...
    fun processAndStore(
        ...
        val strings =
                try {
                    ...
                    val extracted: ExtractedPropositions =
                            operationContext
                                    .ai()
