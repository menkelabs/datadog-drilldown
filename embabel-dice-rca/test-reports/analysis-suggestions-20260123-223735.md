...
Suggested param adjustments:
  - expected_keywords: Add or allow synonyms: unavailable (These terms appear in actual root cause but not in expected keywords....)
...
- **MISSING_KEYWORDS**: Certain keywords are often missing in failed verifications.
  - Consider adding or accepting synonyms: unavailable.
...
|-------|---------|-----------|------------|
| expected_keywords | — | Add or allow synonyms: unavailable | HIGH |
